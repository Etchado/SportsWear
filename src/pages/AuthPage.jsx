...
// ─── OAuth buttons ────────────────────────────────────────────────────────────
function OAuthButtons({ loading, onGoogle }) {
  ...
  return (
    <div className="space-y-3">
      ...
      <button
        ...
        onClick={onGoogle}
        disabled={loading}
        className="w-full flex items-center justify-center gap-3 py-3 rounded-xl border-2 border-light-border dark:border-dark-border font-black text-sm text-light-text dark:text-dark-text hover:border-[#4285F4] transition-colors disabled:opacity-50"
      >
      ...
      <div className="relative">
        <button
          type="button"
          disabled
          className="w-full flex items-center justify-center gap-3 py-3 rounded-xl border-2 border-dashed border-light-border dark:border-dark-border font-black text-sm text-light-muted dark:text-dark-muted opacity-60 cursor-not-allowed"
        >
        ...
        <span className="absolute end-3 top-1/2 -translate-y-1/2 text-[10px] font-black px-2 py-0.5 rounded-full text-white" style={{ background: '#6B7280' }}>
...
function SignIn({ onSwitch, onSuccess }) {
  ...
  return (
    <form onSubmit={submit} className="space-y-4">
      <OAuthButtons loading={loading} onGoogle={handleGoogle} />
      <Divider />
